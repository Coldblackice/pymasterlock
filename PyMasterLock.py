...
if ( sys.argv[1] == '-help' or '--help'):
	l1_help = "Find the 'First Locked Position' \r\n\tRotate dial to the left (towards 10) hard until the dial gets locked. Notice how the dial is locked into a small groove. If you're directly between two digits such as 3 and 4, release the shackle and turn the dial left further until you're into the next locked groove. However, if the dial is between two half digits (e.g., 2.5 and 3.5), then enter the digit in-between (e.g., 3) into First Locked Position in the calculator below."
	l2_help = "Find the 'Second Locked Position' \r\n\tDo all of the above again until you find the second digit below 11 that is between two half digits (e.g., 5.5 and 6.5), and enter the whole number (e.g., 7) into Second Locked Position in the calculator below."
	r1_help = "Find the 'Resistant Location' \r\n\tApply half as much pressure to the shackle so that you can turn the dial. Rotate dial to the right until you feel resistance. Rotate the dial to the right several more times to ensure you're feeling resistance at the same exact location.Enter this number into Resistant Location. If the resistance begins at a half number, such as 14.5, enter 14.5."
	print l1_help
	print
	print l2_help
	print
